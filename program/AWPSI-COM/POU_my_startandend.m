function [molecular_vecter,molecular_Signal]=POU_my_startandend(numBasis,molecular_start,molecular_end,sigma,dt,Signal)
...
molecular_vecter=zeros(length(molecular_start),length(Signal));
...
%     end
% end
for i=1:length(molecular_start)
    molecular_vecter(i,:)=sum(basisValues(molecular_start(i):molecular_end(i),:),1);
end
